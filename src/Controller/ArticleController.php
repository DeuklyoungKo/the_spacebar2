...
class ArticleController extends AbstractController
{
    ...
    public function show($slug, MarkdownHelper $markdownHelper, bool $isDebug)
    {
        ...
        $comments = ['I ate a normal rock once. It did NOT taste like bacon!', 'Woohoo! I\'m going on an all-asteroid diet!', 'I like bacon too! Buy some from my site! bakinsomebacon.com',];

        $articleContent = <<<EOF
Spicy **jalapeno bacon** ipsum dolor amet veniam shank in dolore. Ham hock nisi landjaeger cow, lorem proident [beef ribs](http://baconipsum.com/) aute enim veniam ut cillum pork chuck picanha. **Dolore reprehenderit labore minim** pork belly spare ribs cupim short loin in. Elit exercitation eiusmod dolore cow **turkey** shank eu pork belly meatball non cupim.
